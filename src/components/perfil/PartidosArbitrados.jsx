...
const PartidosArbitrados = ({ id }) => {
  ...
  useEffect(() => {
    fetch(`${API_URL}getPartidosArbitro/${id}?page=${page}&per_page=${perPage}`)
      .then(res => res.json())
      .then(({ data, last_page }) => {
        setPartidos(data);
  ...
  return (
    <section className="px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Partidos arbitrados</h1>
...
export default PartidosArbitrados;
